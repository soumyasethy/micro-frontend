...
[ -d $APP_PATH ] && cp -R $BUILD_PATH $APP_PATH && echo "👉 Copy @volt/micro-frontend -> Volt-App ✅ "
...
#[ -d $NO_CODE_PATH ] && cp -R $BUILD_PATH $NO_CODE_PATH && echo "👉 Copy @volt/micro-frontend -> NO_CODE_PATH ✅ "
