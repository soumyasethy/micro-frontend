...
[ -d $APP_PATH ] && cp -R $BUILD_PATH $APP_PATH && echo "👉 Copy @blue-learn/micro-frontend -> BlueLearn-App ✅ "
...
[ -d $NO_CODE_PATH ] && cp -R $BUILD_PATH $NO_CODE_PATH && echo "👉 Copy @blue-learn/micro-frontend -> NO_CODE_PATH ✅ "
