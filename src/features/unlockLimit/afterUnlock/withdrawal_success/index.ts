...
export const template: (
    ...
    datastore: <Datastore>{
        ...
        message: <TypographyProps>{
            label: "We’re processing your withdrawal request. It should be deposited in XXXX 0802 account in next 2-3 hours.",
        ...
        info: <InfoProps>{
            label: 'Pay as you go',
            message: 'Just pay minimum interest amount every 30 days. The principal can be repaid at the end of the credit limit tenure. There is no fixed emi payment every month, plan the repayments according to your convenience.',
            actionText: '',
...
export const withdrawalSuccessMF: PageType<any> = {
    ...
    actions: {
        [ACTION.WITHDRAWAL_SUCCESS]: verifyOTP,
