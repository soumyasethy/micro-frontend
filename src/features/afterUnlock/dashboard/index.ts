    ...
    return {
        ...
        datastore: <Datastore>{
            ...
            message: <MessageProps>{
                label: 'Your verification is in progress. Meanwhile you can’t withdraw the amount ',
            ...
            amountItem: <AmountCardProps>{
                ...
                progressFillPercentage: `${
                    (Math.max(availableCreditAmount, 0) * 100) /
                    actualLoanAmount
                }%`,
            },
...
export const dashboardMF: PageType<any> = {
    onLoad: async ({ network }, { ...params }) => {
        ...
        const isDisbursalRequestAllowed =
        ...
        if (!isDisbursalRequestAllowed) {
            ...
            const listOfDisbursal = listOfDisbursalResponse.data
            ...
            if (listOfDisbursal) {
                ...
                listOfDisbursal.every(disbursalItem => {
                    if (
                        disbursalItem.disbursalStatus ===
                            CreditDisbursalStatus.APPROVED ||
                        disbursalItem.disbursalStatus ===
                            CreditDisbursalStatus.REQUESTED
                    ) {
